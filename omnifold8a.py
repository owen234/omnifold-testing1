...
def omnifold8a(theta0,theta_unknown_S,iterations, model_step1, model_step2, verbose=0,
               batch_size_setval=10000, epochs_setval=20,
               save_step2_model=False, output_dir="./" ):
...
#                     metrics=['accuracy'])
        ...
        if save_step2_model :
            ...
            tf.keras.models.save_model( model_step2, model_output_dir )
